...
First of all, download the project, run npm install to install all dependencies, then paste your MongoDB URL into the .env file inside the API folder.I used Mailtrap for password reset functionality. You can create an account on Mailtrap to manage your settings. Finally, start the server with npm run dev.
